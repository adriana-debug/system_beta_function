...
// Legacy-style Select with label and options support
...
type FormSelectProps = SelectSharedProps & {
  value?: string;
  defaultValue?: string;
...
const FormSelect = React.forwardRef<HTMLButtonElement, FormSelectProps>(
  ({ label, error, options = [], placeholder = "Select...", value, defaultValue, onValueChange, name, className }, ref) => {
    return (
