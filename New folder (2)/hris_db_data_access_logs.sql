...
CREATE TABLE `data_access_logs` (
  ...
  `access_type` enum('VIEW','EXPORT','PRINT','DOWNLOAD','BULK_ACCESS') COLLATE utf8mb4_unicode_ci NOT NULL,
  `accessed_fields` json DEFAULT NULL COMMENT 'Fields that were accessed',
  `access_reason` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ip_address` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_agent` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`access_id`),
  KEY `idx_access_user` (`user_id`),
  KEY `idx_access_table` (`table_name`),
  KEY `idx_access_created` (`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Sensitive data access audit trail';
