...
CREATE TABLE `request_approvals` (
  ...
  CONSTRAINT `request_approvals_ibfk_1` FOREIGN KEY (`request_id`) REFERENCES `requests` (`request_id`) ON DELETE CASCADE,
  CONSTRAINT `request_approvals_ibfk_2` FOREIGN KEY (`approver_id`) REFERENCES `employees` (`employee_id`) ON DELETE RESTRICT,
  CONSTRAINT `request_approvals_ibfk_3` FOREIGN KEY (`forwarded_to`) REFERENCES `employees` (`employee_id`) ON DELETE SET NULL
